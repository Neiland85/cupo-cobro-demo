...
final class Codes
{
    ...
    public const REFUND_OK = 'REFUND_OK';
    public const REFUND_REPLAY = 'REFUND_REPLAY';
    public const REFUND_UNKNOWN_BLOCKED = 'REFUND_UNKNOWN_BLOCKED';
    public const REFUND_NEEDS_PAYOUT_HOLD = 'REFUND_NEEDS_PAYOUT_HOLD';
